package com.tjj.gulimall.search.service.impl;
...
import com.tjj.gulimall.search.constant.EsConstant;
import com.tjj.gulimall.search.feign.ProductFeignService;
import com.tjj.gulimall.search.service.MallSearchService;
import com.tjj.gulimall.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    /**
     * 准备检索请求:用SearchSourceBuilder构建检索请求
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        if (null != param.getCatalog3Id()) {
            boolQueryBuilder.filter(QueryBuilders.termQuery("catalog", param.getCatalog3Id()));
        }
